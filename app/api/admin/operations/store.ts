...
export async function initialize() {
  if (!initialization) {
    ...
    initialization = sql.transaction([
      ...
      sql`ALTER TABLE boiler_store_orders ADD COLUMN IF NOT EXISTS payment_amount BIGINT, ADD COLUMN IF NOT EXISTS remaining_quantity INTEGER, ADD COLUMN IF NOT EXISTS payment_date TEXT`,
