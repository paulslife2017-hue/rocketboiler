const faqs = [
  ...
  ["새집이나 상가에 신규 설치도 가능한가요?", "네. 신규 설치와 인테리어 후 재설치도 진행합니다. 가스 배관, 급배수와 연통 위치를 사진이나 현장 방문으로 먼저 확인한 뒤 필요한 작업을 안내드립니다."],
  ["보일러 설치 시간은 얼마나 걸리나요?", "기존 제품을 교체하는 현장은 보통 2~3시간 정도 걸립니다. 신규 설치나 배관·연통 공사가 필요한 현장은 확인 후 예상 시간을 따로 말씀드립니다."],
  ["사진으로 먼저 견적을 받을 수 있나요?", "네. 보일러 전체, 모델명 스티커, 아래쪽 배관, 연통 연결부를 찍어 보내주시면 용량과 기본 설치 조건을 먼저 확인할 수 있습니다."],
  ["현장에서 추가 비용이 생길 수도 있나요?", "특수 연통, 배관 이설, 타공처럼 기본 설치에 포함되지 않는 작업이 필요한 경우가 있습니다. 추가 작업은 시공 전에 이유와 금액을 먼저 설명드리고 진행합니다."],
  ["어떤 브랜드를 설치하나요?", "경동나비엔, 귀뚜라미, 린나이, 대성쎌틱 등 국내 주요 브랜드를 취급합니다. 현재 사용 중인 제품과 집 평수, 온수 사용량에 맞춰 비교해 드립니다."],
];
  ...
  return (
    <main id="top">
      ...
      <section className="brands">
        <div><span>취급 브랜드</span><strong>경동나비엔</strong><strong>귀뚜라미</strong><strong>린나이</strong><strong>대성쎌틱</strong></div>
      </section>
