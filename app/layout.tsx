...
export const metadata: Metadata = {
  ...
  title: { default: "서울·경기·인천 보일러 교체 비용·설치 | 로켓보일러", template: "%s | 로켓보일러" },
  description: "서울 전 지역과 군포·안양·과천·광명·부천·고양·구리·하남·성남, 인천 지역 가스보일러 교체 비용과 설치 가격을 사진으로 확인하세요. 인천 영종도·강화군은 방문 지역에서 제외됩니다.",
  ...
  openGraph: {
    ...
    locale: "ko_KR",
    siteName: "로켓보일러",
    title: "서울·경기·인천 보일러 교체 비용·설치 | 로켓보일러",
