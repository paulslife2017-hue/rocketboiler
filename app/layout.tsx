...
export const metadata: Metadata = {
  ...
  description: "서울·경기·인천 가스보일러 교체 비용과 설치 가격을 사진으로 확인하세요. 경동나비엔·귀뚜라미 보일러 교체, 콘덴싱 보일러 설치와 현장 추가 비용을 미리 안내합니다.",
  ...
  openGraph: {
    ...
    description: "경동나비엔·귀뚜라미 가스보일러 교체 비용과 설치 가격을 사진으로 먼저 확인하세요.",
