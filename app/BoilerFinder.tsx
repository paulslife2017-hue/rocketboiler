...
const initialAnswers: Answers = { region: "", homeType: "", area: "", fuel: "", drain: "", controllers: "", extras: [], timing: "", timingTime: "", name: "", phone: "", consent: false };
const extraOptions = [
