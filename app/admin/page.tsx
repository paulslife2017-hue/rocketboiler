...
type Tab = 'overview' | 'leads' | 'schedule' | 'ads' | 'orders' | 'inventory' | 'technicians';
const tabs: { id: Tab; name: string; icon: string }[] = [{ id: 'overview', name: '전체 현황', icon: '◫' }, { id: 'leads', name: '상담 접수', icon: '☷' }, { id: 'schedule', name: '설치 일정', icon: '▦' }, { id: 'technicians', name: '기사 관리', icon: '♙' }, { id: 'orders', name: '스마트스토어 주문', icon: 'N' }, { id: 'inventory', name: '보일러 재고', icon: '▤' }, { id: 'ads', name: '광고 현황', icon: '↗' }];
